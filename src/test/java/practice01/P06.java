...
public class P06 {
    ...
    @Test
    public void test01() {
        driver.findElement(By.xpath("(//*[@ class='QS5gu sy4vM'])[2] ")).click();  // Bu kodu cookies leri kabu etmek icin kullandik.

        // 1 kere kullanilacagi icinde burada yazdik. Baska yerde yazinca hata veriyor.
