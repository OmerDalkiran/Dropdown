...
// wait objesi olusturuyorum
        Wait<WebDriver> wait = new FluentWait<>(driver)
                .withTimeout(Duration.ofSeconds(30))  // max bekleme suresi
                .pollingEvery(Duration.ofSeconds(3))  // her 3 saniyede bir  deneme araliklari
                .withMessage("Ignore Exception")                   // Mesaj yazdirabilirim
                .ignoring(NoSuchMethodException.class);  // Exceptionu hadle et.
